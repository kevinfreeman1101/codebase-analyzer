...
COMPLEXITY METRICS
Average Cyclomatic Complexity: 27.17
QUALITY METRICS
Average Lint Score: 99.95
CODEBASE SUMMARY
===============
...
Directories: 9
Total Files: 141
Total Size: 1107.4 KB
Classes: 182
Functions: 637
Documented: 774 (95% of functions)

File Distribution:
- Sh Files: 2 files
- Toml Files: 1 files
- Unknown Files: 11 files
...
├─ .gitignore
├─ README.md
├─ debug_main_round32.sh
├─ debug_output_round32.txt
├─ example_usage.py
├─ full_output_round32.txt
├─ logging.conf
├─ pyproject.toml
├─ requirements-dev.txt
├─ requirements.lock
├─ requirements.txt
├─ run_full_output_round32.sh
├─ setup.py
├─ summary.md
...
tests/unit/test_analyzers/test_features_manager.py
  ...
  Functions:
    ...
    - test_export_results_html (Lines: 14, Documented: Yes)
    - test_export_results_invalid_format (Lines: 4, Documented: Yes)
    - test_export_results_to_file (Lines: 7, Documented: No)
...
tests/unit/test_analyzers/test_codebase_analyzer.py
  ...
  Functions:
    ...
    - test_analyze_project_with_errors (Lines: 20, Documented: No)
...
codebase_analyzer/analyzer.py.bak3
  Size: 4.3 KB
  (Empty or initialization file)
...
codebase_analyzer/analyzer.py.bak2
  Size: 4.3 KB
  (Empty or initialization file)
...
codebase_analyzer/analyzer.py.bak4
  Size: 4.4 KB
  (Empty or initialization file)

codebase_analyzer/analyzer.py.bak5
  Size: 4.4 KB
  (Empty or initialization file)
...
codebase_analyzer/analyzer.py
  ...
  Functions:
    ...
    - generate_summary (Lines: 12, Documented: Yes)
  Classes:
